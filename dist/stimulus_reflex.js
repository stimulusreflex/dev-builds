...
const initialize = (application, {controller: controller, consumer: consumer, debug: debug, params: params, isolate: isolate, deprecate: deprecate, transport: transport, operations: operations} = {}) => {
  ...
  document.addEventListener(`cable-ready:before-${operations["replace"]}`, beforeDOMUpdate);
  document.addEventListener(`cable-ready:before-${operations["morph"]}`, beforeDOMUpdate);
  document.addEventListener(`cable-ready:after-${operations["replace"]}`, afterDOMUpdate);
  document.addEventListener(`cable-ready:after-${operations["morph"]}`, afterDOMUpdate);
