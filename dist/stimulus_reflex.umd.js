(function(global, factory) {
  ...
  const XPathToElement = CableReady.Utils.xpathToElement;
  const XPathToArray = CableReady.Utils.xpathToElementArray;
  const debounce = CableReady.Utils.debounce;
  const emitEvent = (name, detail = {}) => CableReady.Utils.dispatch(document, name, detail);
